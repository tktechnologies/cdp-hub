...
**Rules:** Put volatile ops facts in `implementation-state.md` (snapshot at top). Workflow IDs live **only** here and in `docs/n8n/LIVE_WORKFLOWS.md` — service memory, skills, and prompts must link, not copy. Do not duplicate long changelogs in prompts.
